...
import { Popover, PopoverContent, PopoverTrigger } from "../popover"; // Add PopoverTrigger
    ...
    <div className="bg-white shadow-md border-b">
          ...
          </ul>
      {
        !user ? (
         ...
         <Link to="/signup"> <Button className=" bg-[#FF6B6B]   hover:bg-[#434242]">Signup</Button></Link>    
          </div>
